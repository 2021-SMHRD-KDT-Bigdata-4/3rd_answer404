	...
	<div class="checkout__order">
		<div class="col-lg-3">
			<div class="header__logo">
				<a><img src="${cpath}/resources/img/logo_trans.png" alt=""></a>
			</div>
						...
						<div class="col-lg-6">
							<div class="checkout__input">
								...
								<input type="password" id="member_password"
									name="member_password" placeholder="PW">
							</div>
						</div>
					</div>
				</div>
				<button id="loginBtn" type="submit" onclick="loginAction();"
					class="site-btn">로그인</button>
