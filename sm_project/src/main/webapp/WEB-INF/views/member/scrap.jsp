				...
				<div class="col-lg-6">
					<nav class="header__menu">
						<ul>
							...
							<li><a
								href="../news/econo_category?news_category=사회&&pagingNum=1">사회</a></li>
							<li><a
								href="../news/econo_category?news_category=정치&&pagingNum=1">정치</a></li>
							<li><a
								href="../news/econo_category?news_category=IT/과학&&pagingNum=1">IT/과학</a></li>
						</ul>
					</nav>
				</div>
				...
				<div class="col-lg-12 col-md-8">
					...
					<div class="col-lg-12">
						<div class="product__pagination blog__pagination">
							...
							<c:if test="${prev}">
								<a
									href="/member/scrap?member_id=${member.member_id}&&pagingNum=${startPageNum - 1}"><i
									class="fa fa-long-arrow-left"></i></a>
							</c:if>

							<c:forEach begin="${startPageNum}" end="${endPageNum+1}"
								var="num">
								<c:if test="${select != num}">
									<a
										href="/member/scrap?member_id=${member.member_id}&&pagingNum=${num}">${num}</a>
								</c:if>
							...
							<c:if test="${next}">
								<a
									href="/member/scrap?member_id=${member.member_id}&&pagingNum=${endPageNum + 1}"><i
