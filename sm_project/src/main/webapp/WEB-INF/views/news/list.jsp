				...
				<div class="col-lg-12">
					...
					<div class="featured__controls">
						<ul>
							...
							<li data-filter=".oranges">경제</li>
							<li data-filter=".fresh-meat">사회</li>
							<li data-filter=".vegetables">정치</li>
							<li data-filter=".fastfood">IT/과학</li>
						</ul>
					</div>
				</div>
			</div>
		...
		<div class="pagenation">
			<ul>
				<c:if test="${pageMaker.prev}">
					<li><a style=" width: 50px !important" href="list${pageMaker.makeSearch(pageMaker.startPage - 1)}">이전</a></li>
				</c:if>
				...
				<c:if test="${pageMaker.next && pageMaker.endPage > 0}">
					<li><a style=" width: 50px !important" href="list${pageMaker.makeSearch(pageMaker.endPage + 1)}">다음</a></li>
				</c:if>
			</ul>
		</div>
