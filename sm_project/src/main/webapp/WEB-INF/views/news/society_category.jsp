				...
				<div class="col-lg-6">
					<nav class="header__menu">
						<ul>
							...
							<li class="active"><a href="${capth}./society_category?news_category=사회&&pagingNum=1">사회</a></li>
				...
				<div class="col-lg-9 col-md-7">
					...
					<div class="col-lg-12">                        
                            <div class="product__pagination blog__pagination">
                             ...
                             <c:if test="${prev}">
                            	<a href="/news/society_category?news_category=${category}&&pagingNum=${startPageNum - 1}"><i class="fa fa-long-arrow-left"></i></a>
                             </c:if>
                             
                            <c:forEach begin="${startPageNum}" end="${endPageNum}" var="num"> 	
									<c:if test="${select != num}">
										<a href="/news/society_category?news_category=${category}&&pagingNum=${num}">${num}</a>
									</c:if>
                             ...
                             <c:if test="${next}">   
                                <a href="/news/society_category?news_category=${category}&&pagingNum=${endPageNum + 1}"><i class="fa fa-long-arrow-right"></i></a>
                             </c:if>
