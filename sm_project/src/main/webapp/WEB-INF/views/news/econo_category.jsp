				...
				<div class="col-lg-6">
					<nav class="header__menu">
						<ul>
							...
							<li><a href="${capth}./society_category?news_categorie=사회&&pagingNum=1">사회</a></li>
							<li><a href="${capth}./politics_category?news_categorie=정치&&pagingNum=1">정치</a></li>
							<li><a
								href="${capth}./ITscience_category?news_categorie=IT/과학&&pagingNum=1">IT/과학</a></li>
						</ul>
					</nav>
				</div>
				<div class="col-lg-3">
